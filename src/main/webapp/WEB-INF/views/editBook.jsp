            ...
            <div class="content_body add_book_content">
                ...
                <div class="content_right">
                    ...
                    <div>
                        ...
                        <input type="text" id="publisher" name="publisher" value="${bookInfo.publisher}">
                    </div>
                    <div>
                        <span>出版日</span><span class="care care2">必須</span>
                        <input type="text" id="publishDate" name="publishDate" value="${bookInfo.publishDate}">
                    </div>
                    <div>
                        <span>ISBN</span><span class="care care1">任意</span>
                        <input type="text" id="isbn" name="isbn" value="${bookInfo.isbn}">
                    </div>
                    <div>
                        <span>説明文</span><span class="care care1">任意</span>
                        <input type="text" id="description" name="description" value="${bookInfo.description}">
                    </div>
